...
void Example::render()
{
    ...
    // Random lines.
    SDL_Rect rectangle{randomize(windowWidth()), randomize(windowHeight()), 2, randomize(windowHeight())};
    SDL_SetRenderDrawColor(currentRenderer(), randomize(255), randomize(255), randomize(255), 255);
    ...
    renderTextFont("fontEx", "Simple DirectMedia Layer", {130, 70}, white, 24, 344, 1, 255, SDL_FLIP_NONE);
}
